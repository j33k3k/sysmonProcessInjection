...
## Purpose
This lab documents Sysmon detection coverage across the a broad spectrum of Windows process injection techniques from a defensive security
...
Based on the process injection techniques documented at
